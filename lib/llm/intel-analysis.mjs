...
/** Pull a JSON array from raw model text (bare array, fenced block, or wrapped object). */
function extractIntelArray(cleaned) {
  ...
  // First balanced `[...]` slice (non-greedy — avoids broken greedy regex on long responses)
